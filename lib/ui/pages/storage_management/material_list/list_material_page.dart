...
class TabListMaterial extends StatelessWidget {
  const TabListMaterial({Key? key}) : super(key: key);
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child:_buildItem(name: "Vật tư: Phân bón"),
              ),
      ...
      child: Container(
        ...
        child: Slidable(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                Image.asset(avatarUrl ?? AppImages.icSupplise),
                SizedBox(width: 18),
                Expanded(
                  child: Column(
                    ...
                    children: [
                     ...
                     SizedBox(height: 5,),
                      Text("Số lượng: 200 Kg", style: AppTextStyle.blackS14,)
                    ],
                  )
                ),
                Icon(
