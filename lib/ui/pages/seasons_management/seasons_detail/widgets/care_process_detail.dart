...
//   late List<StageSeason>? stageList;
...
//         StageSeason stage = stageList![i];
//         graphHeight += 30;
//         for (int j = 0; j < stage.steps!.length; j++) {
//           StepSeason step = stage.steps![j];
...
//                                       (stageIndex) {
//                                     StageSeason stage = stageList![stageIndex];
//                                     return Column(
//                                       children: [
//                                         Container(height: 30),
//                                         // ...List.generate(
...
//             StageSeason stage = stageList![index];
//             return Column(
//               children: [
