...
(async function() {
    ...
    try {
        const response = await uriRequest(BASE_API + "/msx-sts/api/domain/v1/auth/mobile/care/login", "POST", headers, {}, null, {
            ...
            "system":"care",
            "authType": "local", 
            "deviceToken": "dcbZysL-T4CJ9BSd5GP_n7:APA91bEzNkvDAhYbhaN4lj1efHPlqdQE_e96dBy04sqvsloV6EjrxLGpdQ6_Y-SldNS7KOCYKad44VW7GLFhJG_ZyvBES8vzvCUMljX_2nGqEPb2p0NUo9CpvdBwzfN2M_XkdynySM40"
        });
